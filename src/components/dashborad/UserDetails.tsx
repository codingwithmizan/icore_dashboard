...
export const UserDetails: FC<Props> = () => {
  ...
  const user = {
    avatar_url: `https://randomuser.me/api/portraits/${gender}/${Math.floor(Math.random() * 100)}.jpg`,
    firstName: "Jane",
    lastName: "Doe",
  ...
  return (
    <div className="space-y-6 p-6">
      {/* Profile Card */}
      <Card className="flex flex-col items-center gap-6 rounded-xl shadow-md md:flex-row">
        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="text-lg text-emerald-600">{user.designation}</p>
      ...
      {/* About Section */}
      <Card className="!my-4 rounded-xl shadow-sm">
